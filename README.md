...
- `npm run dev` to spin up our Express server (it will be interacting with our database we set up in the [last lesson](https://github.com/SEB-3-Bahrain/u3_lesson_mongoose_auth))
